...
Qsat_1_PA                'isotherm parameter: mol/kg'                                    /1.0325/
Qsat_2_PA                'isotherm parameter: mol/kg'                                    /1.1892/
b_1_PA                   'isotherm parameter'                                            /0.13/
b_2_PA                   'isotherm parameter'                                            /0.13/

Qsat_1_PE                'isotherm parameter: mol/kg'                                    /2.5642/
Qsat_2_PE                'isotherm parameter: mol/kg'                                    /3.3513/
b_1_PE                   'isotherm parameter'                                            /0.1745/
b_2_PE                   'isotherm parameter'                                            /0.1238/
;
...
$CALL 'del PSA_MOF_12.gdx'
$CALL GDXXRW I=PSA_MOF_12.xlsx O=PSA_MOF_12.gdx Index=In_index!A1

$GDXIN PSA_MOF_12.gdx
