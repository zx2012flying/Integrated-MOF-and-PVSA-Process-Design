...
Qsat_1_PA                'isotherm parameter: mol/kg'                                    /0.6546/
Qsat_2_PA                'isotherm parameter: mol/kg'                                    /0.6546/
b_1_PA                   'isotherm parameter'                                            /0.12/
b_2_PA                   'isotherm parameter'                                            /0.12/

Qsat_1_PE                'isotherm parameter: mol/kg'                                    /0.01/
Qsat_2_PE                'isotherm parameter: mol/kg'                                    /4.1393/
b_1_PE                   'isotherm parameter'                                            /69.6628/
b_2_PE                   'isotherm parameter'                                            /0.1/
*Qsat_1_PE                'isotherm parameter: mol/kg'                                    /3.0763/
*Qsat_2_PE                'isotherm parameter: mol/kg'                                    /1.0635/
*b_1_PE                   'isotherm parameter'                                            /0.1/
*b_2_PE                   'isotherm parameter'                                            /0.1/
;
...
$CALL 'del PSA_MOF_11.gdx'
$CALL GDXXRW I=PSA_MOF_11.xlsx O=PSA_MOF_11.gdx Index=In_index!A1

$GDXIN PSA_MOF_11.gdx
